...
const RejectedStud = () => {
    ...
    const handleDelete = async () => {
        try {
            const response = await axios.post('http://localhost:3001/deletedetails1');
    ...
    useEffect(() => {
        ...
        const fetchDetails = async () => {
            try {
                const endpoint = 'http://localhost:3001/detailsrejected';
            ...
            <div className="w-full max-w-7xl mx-auto">
                <div className="bg-green-200/80 backdrop-blur-lg rounded-2xl shadow-lg p-6 md:p-12 w-full">
                    <div className='flex flex-col md:flex-row justify-between items-center mb-8'>
                        <h1 className="text-2xl md:text-4xl font-bold text-green-900 text-center mb-4 md:mb-0">
                            Rejected Records
                        </h1>
                        <button 
